...
Window {
    ...
    Item {
        ...
        ListModel {
            ...
            ListElement { name: "Earth"; facts: "The
            ...
            ListElement { name: "Mars"; facts: "Mars
...
//                            wrapMode: Text.wrapMode
                ...
                states: [
                    State {
                        ...
                        PropertyChanges {
                            target: image; width: listView.width; height: listView.width;
                        ...
                        PropertyChanges {
                            target: listView; contentY: wrapper.y; interactive: false
                        }
